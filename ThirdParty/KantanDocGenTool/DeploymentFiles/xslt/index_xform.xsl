...
version="2.0">
  ...
  <xsl:template match="classes">
    ...
    <table cellspacing="0">
      <tbody>
        ...
        <xsl:apply-templates select="class[(type='Class')and(native='True')]">
    ...
    <table cellspacing="0">
      <tbody>
        ...
        <xsl:apply-templates select="class[(type='Struct')and(native='True')]">
          <xsl:sort select="substring(display_name,2)"/>
        </xsl:apply-templates>
    ...
    <table cellspacing="0">
      <tbody>
        ...
        <xsl:apply-templates select="class[(type='Enum')and(native='True')]">
          <xsl:sort select="substring(display_name,2)"/>
        </xsl:apply-templates>
    ...
    <table cellspacing="0">
      <tbody>
        ...
        <xsl:apply-templates select="class[(type='Class')and(native='False')]">
          <xsl:sort select="substring(display_name,string-length(substring-before(display_name, '_'))+1)"/>
        </xsl:apply-templates>
      </tbody>
    </table>
    ...
    <table cellspacing="0">
      <tbody>
        ...
        <xsl:apply-templates select="class[(type='Struct')and(native='False')]">
          <xsl:sort select="substring(display_name,2)"/>
        </xsl:apply-templates>
      </tbody>
    </table>
    ...
    <table cellspacing="0">
      <tbody>
        ...
        <xsl:apply-templates select="class[(type='Enum')and(native='False')]">
          <xsl:sort select="substring(display_name,2)"/>
        </xsl:apply-templates>
      </tbody>
    </table>
  ...
  <!-- List all native classes-->
  <xsl:template match="class[(type='Class')and(native='True')]">
    <tr class="normal-row">
  ...
  <!--List all native enums-->
  <xsl:template match="class[(type='Enum')and(native='True')]">
    <tr class="normal-row">
      ...
      <td class="name-cell">
        <p>
          <a>
            ...
            <xsl:value-of select="substring(display_name,1)"/>
          </a>
        </p>
      </td>
  ...
  <!--List all native structs-->
  <xsl:template match="class[(type='Struct')and(native='True')]">
    <tr class="normal-row">
      ...
      <td class="name-cell">
        <p>
          <a>
            ...
            <xsl:value-of select="substring(display_name,2)"/>
          </a>
        </p>
      </td>
  ...
  <!--List all BP classes-->
  <xsl:template match="class[(type='Class')and(native='False')]">
    <tr class="normal-row">
  ...
  <!--List all BP enums-->
  <xsl:template match="class[(type='Enum')and(native='False')]">
    <tr class="normal-row">
  ...
  <!--List all BP structs-->
  <xsl:template match="class[(type='Struct')and(native='False')]">
    <tr class="normal-row">
